    ...
    public static class CactusSystem
    {
        ...
        public static void Load()
        {
            for (int i = 0; i < Cacti.Length; i++)
            {
                ...
                Cacti[i].Transform.Position = new Vector2(
                    ...
                    (GameSettings.ScreenHeight * .5f) + 108
                );
            }
        }
        ...
        public static void Update()
        {
            for (int i = 0; i < Cacti.Length; i++)
            {
                ...
                var dinasaurAABB = new Rectangle(DinasaurSystem.Dinosaur.Transform.Position.ToPoint(), DinasaurSystem.Dinosaur.Hitbox.AABB.Size);

                if (cactiAABB.Intersects(dinasaurAABB))
